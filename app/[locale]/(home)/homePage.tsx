      ...
      <section>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
          ...
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl font-bold md:text-5xl"> {t('Features.BigTitle')} </h2>
            <p className="mb-8 mt-4 max-w-xl text-base text-gray-500 md:mb-12 md:text-lg lg:mb-16"> {t('Features.SmallTitle')} </p>
          </div>

          <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3 md:gap-4 lg:gap-6">

            <div className="grid gap-6 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              <img src="/icons1.png" alt="" className="inline-block h-16 w-16 object-cover rounded-full " />
              <h3 className="text-xl font-semibold">{t('Features.Features1')}</h3>
              <p className="text-sm text-gray-500"> {t('Features.Features1des')} </p>
            </div>

            <div className="grid gap-6 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              <img src="/icons2.png" alt="" className="inline-block h-16 w-16 object-cover rounded-full " />
              <h3 className="text-xl font-semibold">{t('Features.Features2')}</h3>
              <p className="text-sm text-gray-500"> {t('Features.Features2des')} </p>
            </div>

            <div className="grid gap-6 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              <img src="/icons3.png" alt="" className="inline-block h-16 w-16 object-cover rounded-full " />
              <h3 className="text-xl font-semibold">{t('Features.Features3')}</h3>
              <p className="text-sm text-gray-500"> {t('Features.Features3des')} </p>
            </div>

            <div className="grid gap-6 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              <img src="/icons4.png" alt="" className="inline-block h-16 w-16 object-cover rounded-full " />
              <h3 className="text-xl font-semibold">{t('Features.Features4')}</h3>
              <p className="text-sm text-gray-500"> {t('Features.Features4des')} </p>
            </div>

            <div className="grid gap-6 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              <img src="/icons5.png" alt="" className="inline-block h-16 w-16 object-cover rounded-full " />
              <h3 className="text-xl font-semibold">{t('Features.Features5')}</h3>
              <p className="text-sm text-gray-500"> {t('Features.Features5des')} </p>
            </div>

            <div className="grid gap-6 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              <img src="/icons6.png" alt="" className="inline-block h-16 w-16 object-cover rounded-full " />
              <h3 className="text-xl font-semibold">{t('Features.Features6')}</h3>
              <p className="text-sm text-gray-500"> {t('Features.Features6des')} </p>
            </div>
          </div>
        </div>
      </section>
